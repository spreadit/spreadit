...
<div class="row-fluid">
    <div class="span12">
        ...
        <ul>
            <li><a href="/preferences/theme/light">Light color scheme</a></li>
            <li><a href="/preferences/theme/dark">Dark color scheme</a></li>
            <li><a href="/preferences/theme/tiles">Tiles theme (unfinished)</a></li>
        </ul>
    </div>
</div>
@stop
